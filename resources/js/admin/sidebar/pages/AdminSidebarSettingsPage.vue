      ...
      <div class="space-y-4">
        ...
        <Dialog :open="editorOpen" @update:open="editorOpen = $event">
          <DialogScrollContent class="max-w-[calc(100%-2rem)] md:max-w-4xl">
            <DialogHeader>
              <DialogTitle>Edit Admin Sidebar JSON</DialogTitle>
              <DialogDescription>
                Update the platform admin navigation JSON stored by the API.
              </DialogDescription>
            </DialogHeader>

            <Textarea
              v-field-help="'Edit the admin sidebar structure as valid JSON.'"
              v-model="editorValue"
