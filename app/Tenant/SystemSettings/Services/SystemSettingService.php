...
use App\Tenant\SystemSettings\Models\SystemSetting;
use App\Tenant\SystemSettings\Models\SystemSettingHistory;
...
class SystemSettingService
{
    ...
    public function values(bool $publicOnly = false): array
    {
        ...
        foreach (self::ALIASES as $legacyKey => $key) {
            ...
            $values[$legacyKey] = $values[$key]
                ?? $this->castValue((string) $definition['type'], $definition['default']);
        }
