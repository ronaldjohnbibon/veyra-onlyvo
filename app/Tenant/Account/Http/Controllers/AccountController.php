...
class AccountController extends Controller
{
    public function show(): JsonResponse
    {
        ...
        return $this->success($this->accountPayload($user), 'Account workspace retrieved.');
    }
    ...
    public function updateProfile(AccountProfileRequest $request): JsonResponse
    {
        ...
        return $this->success($this->accountPayload($user->fresh()), 'Profile updated.');
    }
    ...
    public function updatePassword(AccountPasswordRequest $request): JsonResponse
    {
        ...
        return $this->success($this->accountPayload($user->fresh()), 'Password updated.');
    }
