    ...
    private function item(): array
    {
        return [
            ...
            'field_schema'  => [
                ...
                ['key' => 'primary_cta', 'label' => 'Primary CTA', 'type' => 'cta', 'description' => 'Configure the main contact form for this landing page.'],
            ...
            'default_content' => [
                ...
                'primary_cta'              => [
                    ...
                    'title'           => 'Contact Us',
                    'description'     => 'Invite visitors to start a conversation, request details, or send a message from the page.',
                    'submit_label'    => 'Submit',
                    ...
                    'fields'          => [
                        ...
                        ['key' => 'email', 'label' => 'Email', 'type' => 'email', 'required' => true, 'placeholder' => 'Your Email'],
                        ['key' => 'message', 'label' => 'Message', 'type' => 'textarea', 'required' => true, 'placeholder' => 'Message'],
                    ],
                ],
