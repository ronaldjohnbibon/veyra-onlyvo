...
class SystemSettingService
{
    ...
    private const DEFINITIONS = [
        ...
        'general.support_email'           => ['group' => 'general', 'label' => 'Support Email', 'type' => 'email', 'default' => '', 'public' => true, 'description' => 'Enter the support email shown to users and used as Reply-To for Admin emails.'],
        ...
        'email.mail_driver'   => ['group' => 'email', 'label' => 'Mail Driver', 'type' => 'select', 'default' => 'smtp', 'public' => false, 'description' => 'Choose the shared mail service used for every Admin and Tenant email.', 'options' => ['smtp' => 'SMTP', 'resend' => 'Resend', 'sendmail' => 'Sendmail', 'mailgun' => 'Mailgun', 'ses' => 'Amazon SES', 'ses-v2' => 'Amazon SES v2', 'postmark' => 'Postmark', 'log' => 'Log', 'array' => 'Array']],
        ...
        'email.smtp_password' => ['group' => 'email', 'label' => 'SMTP Password', 'type' => 'password', 'default' => '', 'public' => false, 'description' => 'Enter the SMTP password when SMTP delivery is selected.'],
        'email.sender_name'   => ['group' => 'email', 'label' => 'Sender Name', 'type' => 'string', 'default' => 'Onlyvo', 'public' => false, 'description' => 'Enter the default display name used for Admin email. Tenant email may use the tenant business name.'],
        'email.sender_email'  => ['group' => 'email', 'label' => 'Sender Email', 'type' => 'email', 'default' => 'hello@example.com', 'public' => false, 'description' => 'Enter the verified From address shared by every Admin and Tenant email.'],
